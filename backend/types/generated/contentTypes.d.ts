...
export interface ApiCapacitacionCapacitacion
  ...
  attributes: {
    actualizacion: Schema.Attribute.Date;
    contenidos: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiContenidoContenido extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    minutos: Schema.Attribute.Integer;
...
export interface ApiRolesAppRolesApp extends Struct.SingleTypeSchema {
  collectionName: 'roles_apps';
  info: {
    displayName: 'roles-app';
    pluralName: 'roles-apps';
    singularName: 'roles-app';
  };
  options: {
    draftAndPublish: true;
  };
